...
public class JoinMeetAfter {
	...
	private void initialize() {
		...
		text_count.setBounds(107, 50, 14, 25);
		...
		lbl_countblock.setBounds(107, 51, 14, 22);
		...
		lbl_set.setBounds(313, 29, 29, 35);
