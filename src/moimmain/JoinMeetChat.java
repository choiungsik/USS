...
public class JoinMeetChat {
	...
	private void initialize() {
		...
		lbl_countblock.setBounds(106, 53, 14, 22);
		...
		lbl_set.setBounds(309, 31, 29, 35);
		...
		lbl_exit.setBounds(335, 31, 29, 35);
...
//		frame.getContentPane().add(btn_study);
		...
		lbl_chart.setBounds(144, 31, 57, 24);
