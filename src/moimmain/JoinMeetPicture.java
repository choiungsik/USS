...
public class JoinMeetPicture {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					JoinMeetPicture window = new JoinMeetPicture();
	...
	private void initialize() {
		...
		String path = "C:\\Users\\smhrd\\Downloads\\수업내용정리\\작업\\javaworkspace\\total\\src\\icon\\img\\가입후사진.png";
		...
		text_count.setBounds(105, 51, 14, 25);
		...
		lbl_countblock.setBounds(104, 49, 14, 22);
		...
		lbl_set.setBounds(308, 29, 29, 35);
		...
		lbl_exit.setBounds(335, 29, 29, 35);
		...
		lbl_chart.setBounds(139, 29, 57, 24);
