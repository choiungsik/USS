...
public class JoinMeetMember2 {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					JoinMeetMember2 window = new JoinMeetMember2();
	...
	private void initialize() {
		...
		String path = "C:\\Users\\smhrd\\Downloads\\수업내용정리\\작업\\javaworkspace\\total\\src\\icon\\img (3)\\멤버확인.png";
		...
		text_count.setBounds(112, 39, 14, 25);
		...
		lbl_countblock.setBounds(111, 39, 14, 22);
		...
		lbl_exit.setBounds(335, 17, 29, 35);
		...
		lbl_chart.setBounds(149, 16, 57, 24);
